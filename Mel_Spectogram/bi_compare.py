...
file_path1 = './../filtered_algo/recording.wav'  
file_path2 = './../filtered_algo/recording_filtered_output.wav'  
...
img1 = plot_mel_spectrogram(ax1, data1, sr1, 'Mel Spectrogram -  Original')
img2 = plot_mel_spectrogram(ax2, data2, sr2, 'Mel Spectrogram - Filtered Sound')
